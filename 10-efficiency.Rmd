...
```{r, fig.alt="File reading speed demonstration with different formats"}
...
```{r, fig.alt="File reading speed demonstration long vs wide format"}
...
```{r, fig.alt="File reading speed demonstration different CSV reading packages"}
