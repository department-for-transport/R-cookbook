...
```{r, fig.alt="Crashes Q"}
knitr::include_graphics("image/crashesq.png")
```
...
```{r, fig.alt="Cornwall map"}
knitr::include_graphics("image/Cornwall1.png")
```
...
```{r, fig.alt="Cornwall Compare"}
knitr::include_graphics("image/CornwallCompare.png")
```
...
```{r, fig.alt="Static 1"}
knitr::include_graphics("image/static1.png")
```
...
```{r, fig.alt="Static 2"}
knitr::include_graphics("image/static2.png")
```
...
More information on using {leaflet} in R can be found here: [https://rstudio.github.io/leaflet/](https://rstudio.github.io/leaflet/)
